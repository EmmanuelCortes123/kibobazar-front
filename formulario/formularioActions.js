        ...
        <div class="col-sm-4 mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <button onclick="agCarrito('${producto.nombre}')" class="btn btn-primary">
              ...
              <div class="container-buttons-card">
                ...
                <button onclick ="borrarProducto(${indice})" class="cart">
								...
								<button onclick="agCarrito('${producto.nombre}')" class="cart">
...
const agregarCarr=(carr)=>{
  const index= carrit.findIndex(
    element => element.name === carr.name
  );
